...
import { DomainRegion } from 'resend/build/src/domains/interfaces/domain'
  ...
  return (
    ...
    >
      ...
      <Form.Dropdown {...itemProps.region} title="Region">
        {regions?.map((region) => {
          return <Form.Dropdown.Item key={region.value} title={region.title} value={region.value}></Form.Dropdown.Item>
        })}
      </Form.Dropdown>
    </Form>
  )
